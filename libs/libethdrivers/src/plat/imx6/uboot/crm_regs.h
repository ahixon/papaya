...
struct mxc_alg_reg {
	...
	u32 pll_sys_clr;
	u32 pll_sys_tog;
	u32 usb1_pll_480_ctrl;		/* 0x4010 */
	u32 usb1_pll_480_ctrl_set;
	u32 usb1_pll_480_ctrl_clr;
	u32 usb1_pll_480_ctrl_tog;
	u32 reserved0[4];
	u32 pll_528;			/* 0x4030 */
	u32 pll_528_set;
	u32 pll_528_clr;
	u32 pll_528_tog;
	u32 pll_528_ss;			/* 0x4040 */
	u32 reserved1[3];
	u32 pll_528_num;			/* 0x4050 */
	u32 reserved2[3];
	u32 pll_528_denom;		/* 0x4060 */
	u32 reserved3[3];
	u32 pll_audio;			/* 0x4070 */
	u32 pll_audio_set;
	u32 pll_audio_clr;
	u32 pll_audio_tog;
	u32 pll_audio_num;		/* 0x4080*/
	u32 reserved4[3];
	u32 pll_audio_denom;		/* 0x4090 */
	u32 reserved5[3];
	u32 pll_video;			/* 0x40a0 */
	u32 pll_video_set;
	u32 pll_video_clr;
	u32 pll_video_tog;
	u32 pll_video_num;		/* 0x40b0 */
	u32 reserved6[3];
	u32 pll_vedio_denon;		/* 0x40c0 */
	u32 reserved7[7];
	u32 pll_enet;			/* 0x40e0 */
	u32 pll_enet_set;
	u32 pll_enet_clr;
