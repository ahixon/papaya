...
#ifdef __GNUC__
    /* Help the compiler catch incorrect printf invocations. */
    #define PRINTF(format_arg, first_non_format_arg) \
        __attribute__((format (printf, format_arg, first_non_format_arg)))
    #define SCANF(format_arg, first_non_format_arg) \
        __attribute__((format(scanf, format_arg, first_non_format_arg)))
#else
    #define PRINTF(...) /* Nothing */
    #define SCANF(...) /* Nothing */
#endif
...
int fprintf(FILE *, const char *, ...) PRINTF(2, 3);
int fscanf(FILE *, const char *, ...) SCANF(2, 3);
int printf(const char *, ...) PRINTF(1, 2);
int scanf(const char *, ...) SCANF(1, 2);
int snprintf(char *, size_t , const char *, ...) PRINTF(3, 4);
int sprintf(char *, const char *, ...) PRINTF(2, 3);
int sscanf(const char *, const char *, ...) SCANF(2, 3);
