...
#define SYSCALL_SHAREDBUF_CREATE	(9)
#define SYSCALL_SHAREDBUF_MOUNT		(10)

#define SYSCALL_PROCESS_SUICIDE		(11)
#define SYSCALL_PROCESS_CREATE		(12)
#define SYSCALL_PROCESS_DESTROY		(13)
#define SYSCALL_PROCESS_GETPID		(14)
#define SYSCALL_PROCESS_SEND_STATUS	(15)
#define SYSCALL_PROCESS_WAIT		(16)
